...
const commonSpaceTypes = ['아파트', '빌라/다세대', '오피스텔', '주택', '원룸', '사무실', '상가/매장', '학원', '병원', '공방', '창고', '기타 상업 공간'];
...
const commonDirtOptions = [
  ...
  '반려동물 털', '냄새', '담배냄새/찌든냄새', '짐이 있어요', '부분 인테리어 후 먼지', '페인트 자국/먼지', '잘 모르겠어요'
];
const commonPhotoGuide = [
  ['에어컨 모델명 또는 제품 스티커', '모델명/제품 스티커가 가장 중요합니다. 모델명 라벨이나 제품 스티커가 보이게 찍어주세요. 견적과 작업 가능 여부 확인에 가장 중요합니다.'],
  ['에어컨 전체 모습', '벽걸이, 스탠드, 2 in 1, 시스템 에어컨의 전체 모습이 보이게 찍어주세요. 2 in 1인 경우 스탠드와 벽걸이 전체가 각각 보이게 찍어주세요.'],
  ['설치 위치', '거실, 안방, 작은방, 천장 위치처럼 설치된 공간이 보이면 좋습니다.'],
  ['걱정되는 부분', '송풍구, 필터 주변, 먼지, 곰팡이, 냄새가 걱정되는 부분을 찍어주세요.'],
  ['실외기 주변', '실외기 확인이 필요한 경우 실외기 주변도 함께 찍어주세요.'],
...
const balancedBlogTitle = '어떤 청소가 필요하신가요?';
const balancedBlogBody = '에어컨 청소, 입주청소, 이사청소를\n한 번에 상담받을 수 있습니다.\n\n집 상태와 청소 범위를 확인한 뒤\n상황에 맞는 상담을 도와드립니다.';
...
const companySettings = {
  zendella: {
    ...
    leadWebhookUrl: 'https://script.google.com/macros/s/AKfycby2jDQ6GL_QVe6k4LvT4vnBPIY_eNsdBnosqczXMZR4YuwvMa9omPsnp8dEFH6NAK79-A/exec',
    kakaoChannelLink: '',
    naverTalkLink: '',
  ...
  tsunami: {
    companyName: '쓰나미파워클린',
    logoText: '쓰',
    logo: 'assets/logos/tsunami-power-clean-logo-header.png',
    logoAlt: '쓰나미파워클린 로고',
    logoMark: '쓰',
    mainColor: '#256FAF',
    subColor: '#F3FAFF',
